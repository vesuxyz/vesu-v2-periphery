...
//             //   - input token: debt asset and output token: collateral asset, since we specify a positive input
//             amount //     of the debt asset
//             // for depositing an exact amount of collateral:
//             //   - input token: collateral asset and output token: debt asset, since we specify a negative input
//             amount //     of the collateral asset (swap direction is reversed)
...
//             //   - input token: collateral asset and output token: debt asset, since we specify a positive input
//             amount //     of the collateral asset
//             // for repaying an exact amount of debt:
//             //   - input token: debt asset and output token: collateral asset, since we specify a negative input
//             amount //     of the debt asset (swap direction is reversed)
